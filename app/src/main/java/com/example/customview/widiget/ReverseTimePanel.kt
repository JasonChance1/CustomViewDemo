...
class ReverseTimePanel(context: Context, attributeSet: AttributeSet?) : View(context, attributeSet) {
...
//        // 绘制数字（12、3、6、9）- 保持位置不变，但理解方式相反
//        drawNumbers(canvas)

        // 绘制指针 - 逆时针旋转
        drawReverseHands(canvas)
...
//    }
     ...
     * 绘制逆时针旋转的时针、分针、秒针
     */
    private fun drawReverseHands(canvas: Canvas) {
